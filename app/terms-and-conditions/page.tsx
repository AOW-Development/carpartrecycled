        ...
        <div className="max-w-4xl mx-auto">
          <section className="mb-10">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                carefully before using the partsrecycled.us website (the
                "Service") operated by Parts Recycled LLC LLP ("us", "we", or
                "our").
              </p>
              <p>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4 text-muted-foreground px-4">
              <p>
                ...
                are and will remain the exclusive property of partsrecycled.us
                and its licensors.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4 text-muted-foreground px-4">
              <p>
                ...
                services that are not owned or controlled by 'Parts Recycled
                LLC' has no control over, and assumes no responsibility for, the
                content, privacy policies, or practices of any third-party web
                sites or services. You further acknowledge and agree that
                partsrecycled.us shall not be responsible or liable, directly or
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4 text-muted-foreground px-4">
              ...
              <p>
                By opting in to SMS communications from Parts Recycled LLC, you
              ...
              <p>
                ...
                carrier's pricing plan. Parts Recycled LLC is not responsible
                for any associated charges.
              </p>

              <h3 className="text-xl font-semibold mt-6">3. Opt-In Methods</h3>
              <p>
                You can opt-in to receive SMS messages from Parts Recycled LLC
                by:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
              ...
              <p>
                ...
                or visit{" "}
                <a
                  href="https://www.partsrecycled.us/"
                  className="text-primary hover:underline"
                >
              ...
              <p>Parts Recycled LLC may send messages such as:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  "Hi, this is Zack from Parts Recycled LLC. We have the part
              ...
              <p>
                ...
                <a
                  href="https://www.partsrecycled.us/privacy-policy"
                  className="text-primary hover:underline"
                >
                  Privacy Policy
                </a>{" "}
                and{" "}
                <a
                  href="https://www.partsrecycled.us/terms"
                  className="text-primary hover:underline"
                >
                  Terms & Conditions
                </a>{" "}
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-sm text-muted-foreground text-center">
              © {new Date().getFullYear()} Parts Recycled LLC LLP. All rights
              reserved.
            </p>
          </div>
        </div>
